            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb__links">
                        <a href="/ANI_ME/indexServlet"><i class="fa fa-home"></i> Trang chủ</a>
                        <span>Danh sách</span>
                    </div>
                </div>
            </div>
                                ...
                                <div class="product__item">
                                    <a href="/ANI_ME/anime_watchingServlet/watch/${item.maVideo}">
                                        <div class="product__item__pic set-bg" data-setbg="https://img.youtube.com/vi/${item.anhVideo}/maxresdefault.jpg">
                                            ...
                                            <div class="view"><i class="fa fa-eye"></i> ${item.luotXem}</div>
                                        </div>
                                    </a>
                                    <div class="product__item__text">
                                        ...
                                        <h5><a href="/ANI_ME/anime_watchingServlet/watch/${item.maVideo}">${item.tieuDe}</a></h5>
                                    </div>
                                </div>
                            </div> 
                           </c:forEach>                       
