                ...
                <div class="col-lg-6">
                    <div class="login__form">
                        ...
                        <form action="#">
                            ...
                            <div class="input__item">
                                <input type="password" placeholder="Mã xác nhận">
                        ...
                        <a href="./login.html" class="forget_pass">Quay về trang đăng nhập</a>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="login__register">
                        <h3>Đăng ký tài khoản</h3>
                        <a href="./signup.html" class="register-btn">Đăng ký ngay</a>
                    </div>
                </div>
            </div>
