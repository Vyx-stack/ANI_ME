                    ...
                    <div class="header__nav">
                        <nav class="header__menu mobile-menu">
                            <ul>
                                ...
                                <li><a href="/anime-love.html">Quản lý <span class="arrow_carrot-down"></span></a>
                                    <ul class="dropdown">
                                        <li><a href="/ANI_ME/manage_animeServlet">>> Video</a></li>
                                        <li><a href="/ANI_ME/manage_userServlet">>> Người dùng</a></li>
